...
@section('title') {{Str::title($level->name)}}s @endsection
...
@section('content')
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">{{Str::title($level->name)}}s</li>
    </ol>
                    ...
                    <table class="table table-sm table-bordered" id="dataTable" width="100%" cellspacing="0">
                        ...
                        @foreach($users as $user)
                            ...
                            <tr>
                                ...
                                <td><span class="badge badge-secondary"><i class="fas fa-layer-group"></i> {{$user->role ? $user->role->name : 'no role'}}</span></td>
                                ...
                                <td>
                                    ...
                                    <a href="#" data-toggle="modal" data-target="#delete_user"  class="badge badge-danger"><i class="fas fa-trash-alt"></i></a>
                                </td>
                            </tr>
